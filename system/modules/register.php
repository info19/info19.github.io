...
if(!$logged){
	...
	//Код безопасности
	 $sec_key = '6LfjnRUTAAAAAKwFiPgNpjOaW78hykPbBDqyCkLw';
	 $verify = json_decode(file_get_contents("https://www.google.com/recaptcha/api/siteverify?secret=$sec_key&response={$_POST['sec_code']}&remoteip=".$_SERVER['REMOTE_ADDR']), true);
