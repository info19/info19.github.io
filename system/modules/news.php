								...
								foreach($attach_arr as $attach_file){
									...
									//Видео
										...
										if($cnt_attach_video == 1 AND preg_match('/(photo|photo_u)/i', $row_info['attach']) == false){
											...
											$attach_result .= "<div class=\"cursor_pointer clear\" id=\"no_video_frame{$video_id}\" onClick=\"videos.show({$attach_type[2]}, this.href, location.href); return false;\">
											<div class=\"video_inline_icon\"></div><img src=\"/uploads/videos/{$attach_type[3]}/{$attach_type[1]}\" style=\"margin-top:3px\" width=\"175\"  height=\"131\" /></div><div id=\"video_frame{$video_id}\" class=\"no_display\" style=\"padding-top:3px\">{$row_video['video']}</div><div class=\"video_inline_vititle\"></div><a href=\"/video{$attach_type[3]}_{$attach_type[2]}\" onClick=\"videos.show({$attach_type[2]}, this.href, location.href); return false\"><b>{$row_video['title']}</b></a>";
