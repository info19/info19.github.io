...
echoheader();
echoblock('Настройка системы', 'Настройка общих параметров, а также настройка системы безопасности', 'system', 'settings');
...
echoblock('Шаблоны сообщений', 'Настройка шаблонов E-Mail сообщений', 'mail_tpl', 'mail_tpl');
...
echoblock('PHP файлы', 'Редактирование файлов php, которые поддерживают работу сайта', 'php', 'tpl');
