...
var temp = {
	loadTpl: function(folder, tpl){
		$('#loading').fadeIn('fast');
		$.post('/forward.php?mod=tpl&act=loadTpl', {temp: folder, tpl: tpl}, function(data){
			$('#editable').show();
	...
	save: function(){
		...
		tplname = $('#tplname').val();
		$('#loading').fadeIn('fast');
		$.post('/forward.php?mod=tpl&act=save', {folder: folder, tpl: tplname, content: content}, function(data){
	...
	openFolder: function(template, folder){
		$('#loading').fadeIn('fast');
		$.post('/forward.php?mod=tpl&act=opneFolder', {template: template, folder: folder}, function(data){
			$('#loading').fadeOut('fast');
