...
<div class="fllogall">Описание сайта:</div><textarea class="inpu" name="save[description]">{$config['description']}</textarea>

<div class="fllogall">Ключевые слова, <b>указавать через запятую</b></div><textarea class="inpu" name="save[keywords]">{$config['keywords']}</textarea>
