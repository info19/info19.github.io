...
if($_GET['act'] == 'free'){
	...
	$db->query("UPDATE `".PREFIX."_gifts_list` SET price = '0'");
...
[ <a href="?mod=gifts" onClick="window.location.href='?mod=gifts&act=edit&id={$row['gid']}&price='+document.getElementById('price{$row['gid']}').value; return false">сохранить</a> ] [ <a href="?mod=gifts&act=del&id={$row['gid']}">удалить</a> ][ <a href="?mod=gifts&act=free&id={$row['gid']}">сделать бесплатным</a> ]
</div>
HTML;
}
