					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
                                ...
                                <li><span>Mass Request Logs &nbsp;&nbsp;&nbsp;</span></li>
							</ol>
						</div>
					</header>
						...
						<div class="col-md-12">
							<section class="panel">
								<header class="panel-heading">
									...
									<h2 class="panel-title">Mass Request Logs</h2>
								</header>
...
<?php
$table = $prefix . 'logs';
$sql   = mysqli_query($connect, "SELECT * FROM `$table` WHERE type='Mass Requests' ORDER by id DESC");
...
if (isset($_GET['delete-id'])) {
    ...
    $table = $prefix . 'logs';
    $query = mysqli_query($connect, "DELETE FROM `$table` WHERE id='$id' and type='Mass Requests' ");
    echo "<meta http-equiv=Refresh content=0;url=massrequest-logs>";
}
