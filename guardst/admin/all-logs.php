						...
						<div class="col-md-12">
							<section class="panel">
								...
								<div class="panel-body">
                                    ...
                                    <center><a href="?delete-all" class="btn btn-danger" title="Delete all logs"><i class="fa fa-trash-o"></i> Delete All</a></center>
...
<?php
$table = $prefix . 'logs';
$sql   = mysqli_query($connect, "SELECT * FROM `$table` ORDER by id DESC");
