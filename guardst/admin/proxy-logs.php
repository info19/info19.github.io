						...
						<div class="col-md-12">
							<section class="panel">
								<header class="panel-heading">
									...
									<h2 class="panel-title">Proxy Logs</h2>
								</header>
...
<?php
$table = $prefix . 'logs';
$sql   = mysqli_query($connect, "SELECT * FROM `$table` WHERE type='Proxy' ORDER by id DESC");
...
if (isset($_GET['delete-id'])) {
    ...
    $table = $prefix . 'logs';
    $query = mysqli_query($connect, "DELETE FROM `$table` WHERE id='$id' and type='Proxy'");
    echo "<meta http-equiv=Refresh content=0;url=proxy-logs>";
}
