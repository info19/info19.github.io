...
<div class="margin_top_10"></div><div class="allbar_title" [yes]style="margin-bottom:0px;border-bottom:0px"[/yes]>[yes]Вы руководитель в {num}[/yes][no]<div class="no0" style="text-align: center;
    margin-top: -30px;
    line-height: 40px;
    margin-bottom: -15px;
    margin-left: -14px;
    ...
    width: 100%;
    padding: 14px;
    box-shadow: 0 1px 0 0 #d7d8db, 0 0 0 1px #e3e4e8;">Вы не управляете ни одним сообществом</div>[/no]</div>
