...
<div class="clear"></div>
<br>
<div class="err_yellow" id="info_save" style="display:none;font-weight: normal;border: none;color: #8da3bd;width: 710px;font-size: 14px;margin-left: 30px;background: rgba(82, 127, 175, 0.13);margin-top: -16px;"></div>
<div class="clear"></div>
