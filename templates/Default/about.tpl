...
.speedbar {
 ...
 <div class="padcont">
	 <div id="page">
	 <div class="speedbar" style="    margin-top: -20px;
    width: 774px;
    margin-left: -18px;">Правила пользования Сайтом Студентоси</div>
<div class="clear mgclr margin_top_10"></div>
<div style="    line-height: 160%;
    ...
    padding: 14px;
    box-shadow: 0 1px 0 0 #d7d8db, 0 0 0 1px #e3e4e8;">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Добро пожаловать на сайт <b>Студентоси</b>, интернет-ресурс, который помогает Вам поддерживать связь с Вашими старыми и новыми друзьями. Сайт <b>Студентоси</b> – это сетевой проект, объединяющий людей на основании мест учебы или работы. <br>
</div>


<div class="sett_bar_title" style="    height: 81px;
    line-height: 40px;
    width: 773px;
    margin-left: -18px;
    background: #fff;
    padding: 14px;
    box-shadow: 0 1px 0 0 #d7d8db, 0 0 0 1px #e3e4e8;">1. Статус Правил пользования Сайтом Студентоси</div>
<div class="clear mgclr margin_top_10" style="    margin-top: 0px;"></div>
<div style="    line-height: 160%;
    padding: 10px;
    float: left;
    font-weight: normal;
    ...
    padding: 14px;
    box-shadow: 0 1px 0 0 #d7d8db, 0 0 0 1px #e3e4e8;">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• 1.1. Настоящие Правила пользования Сайтом Студентоси (ранее и далее – Правила) утверждены Администрацией Сайта и определяют условия использования и развития Сайта, а также права и обязанности его Пользователей и Администрации. Правила распространяются также на отношения, связанные с правами и интересами третьих лиц, не являющимися Пользователями Сайта, но чьи права и интересы могут быть затронуты в результате действий Пользователей Сайта.<br> 
...
<div class="clear mgclr margin_top_10"></div>
<div class="sett_bar_title" style="    height: 14px;
    line-height: 14px;
    width: 773px;
    margin-left: -18px;
    background: #fff;
    padding: 14px;
    box-shadow: 0 1px 0 0 #d7d8db, 0 0 0 1px #e3e4e8;">2. Статус Сайта Студентоси</div>
<div class="clear mgclr margin_top_10" style="    margin-top: 0px;"></div>
<div style="    line-height: 160%;
    float: left;
    font-weight: normal;
    ...
    padding: 14px;
    box-shadow: 0 1px 0 0 #d7d8db, 0 0 0 1px #e3e4e8;">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• 2.1. Все права на Сайт в целом и на использование сетевого адреса (доменного и поддоменного имени) <a href="http://studentosi.ru">Студентоси</a> принадлежат Администрации Сайта. Последняя предоставляет доступ к Сайту всем заинтересованным лицам в соответствии с настоящими Правилами.<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• 2.2. Настоящими Правилами установлены условия, в соответствии с которыми права на использование информации и результатов интеллектуальной деятельности (включая, но не ограничиваясь литературными, музыкальными, аудиовизуальными произведениями и фонограммами, произведениями графики и дизайна, фотографическими произведениями, программами для ЭВМ) в составе отдельных разделов Сайта, могут принадлежать Пользователям Сайта и иным лицам, самостоятельно создавшим и/или разместившим указанные объекты на Сайте без непосредственного участия Администрации Сайта.<br><br>
</div>
<div class="clear mgclr margin_top_10"></div>
<div class="sett_bar_title" style="    height: 14px;
    line-height: 14px;
    ...
    background: #fff;
    padding: 14px;
    box-shadow: 0 1px 0 0 #d7d8db, 0 0 0 1px #e3e4e8;">3. Администрация Сайта Студентоси</div>
<div class="clear mgclr margin_top_10" style="    margin-top: 0px;"></div>
<div style="    line-height: 160%;
    float: left;
    font-weight: normal;
    ...
    padding: 14px;
    box-shadow: 0 1px 0 0 #d7d8db, 0 0 0 1px #e3e4e8;">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• 3.1. Под Администрацией Сайта Студентоси (ранее и далее – Администрация Сайта, Администрация) в настоящих Правилах, понимается Администрация сетевого интернет-ресурса Студентоси, действующего согласно норм международного законодательства в сфере информационных технологий.<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• 3.2. Обращения, предложения и претензии физических и юридических лиц к Администрации Сайта в связи с настоящими Правилами и всеми вопросами по функционированию Сайта, нарушениями прав и интересов третьих лиц при его использовании, могут быть направлены на электронный адрес admin@studentosi.ru<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• 3.3. В отношении функционирования и развития Сайта Администрация руководствуется международными нормами в сфере интернет-коммуникаций и СМИ, настоящими Правилами и иными специальными документами, которые разработаны или могут быть разработаны и приняты Администрацией Сайта в целях регламентации предоставления Пользователям доступа к отдельному функционалу Сайта.<br> 
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• 3.4. Никакие положения настоящих Правил не предоставляют Пользователю право на использование фирменного наименования, товарных знаков, доменных имен и иных отличительных знаков Администрации Сайта. Право на использование фирменного наименования, товарных знаков, доменных имен и иных отличительных знаков Администрации Сайта может быть предоставлено исключительно по письменному соглашению с Администрацией Сайта.<br><br>
</div>
<div class="clear mgclr margin_top_10"></div>
<div class="sett_bar_title" style="    height: 14px;
    line-height: 14px;
    ...
    background: #fff;
    padding: 14px;
    box-shadow: 0 1px 0 0 #d7d8db, 0 0 0 1px #e3e4e8;">4. Регистрация на Сайте Студентоси и статус Пользователя</div>
<div class="clear mgclr margin_top_10" style="    margin-top: 0px;"></div>
<div style="    line-height: 160%;
    float: left;
    font-weight: normal;
    ...
    padding: 14px;
    box-shadow: 0 1px 0 0 #d7d8db, 0 0 0 1px #e3e4e8;">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• 4.1. Регистрация Пользователя на Сайте является бесплатной, добровольной и производится по адресу в сети Интернет: <a href="http://studentosi.ru">Студентоси</a><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• 4.2. Пользователем Сайта является физическое лицо, зарегистрированное на Сайте в соответствии с установленным настоящими Правилами порядком, и в полной мере возлагающее на себя всю ответственность за размещаемый и просматриваемый материал, для акцепта настоящих Правил, и обладающее соответствующими полномочиями (ранее и далее – Пользователь).<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• 4.3. При регистрации на Сайте Пользователь обязан предоставить Администрации Сайта необходимую достоверную и актуальную информацию для формирования персональной страницы Пользователя, включая уникальные для каждого Пользователя логин (адрес электронной почты либо комбинацию из латинских букв и цифр для входа на Сайт) и пароль доступа к Сайту. Регистрационная форма Сайта может запрашивать у Пользователя дополнительную информацию.<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• 4.4. Пользователь несет ответственность за достоверность, актуальность, полноту и соответствие нормам международных правил в сфере информационных технологий и защиты персональных данных, предоставленной при регистрации информации и ее чистоту от претензий третьих лиц.<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• 4.5. После предоставления информации, указанной в п. 4.3. настоящих Правил, Пользователю необходимо пройти ряд удостоверительных процедур, а именно, (а) подтвердить регистрацию путем распознания автоматизированного теста, предназначенного для различия компьютеров и людей («капчи»); (б) подтвердить свою регистрацию путем активации персональной страницы через сообщение, отправленное Администрацией Сайта на электронную почту Пользователя; В случае верного последовательного выполнения всех регистрационных действий на Сайте создается персональная страница Пользователя, имеющая сетевой адрес вида <a href="http://studentosi.ru/u1">http://studentosi.ru/u[номер]</a>. Пользователь вправе зарегистрировать не более одной персональной страницы на Сайте.<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• 4.6. При регистрации Пользователь соглашается с настоящими Правилами и принимает на себя указанные в них права и обязанности, связанные с использованием и функционированием Сайта.<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• 4.11. После регистрации Пользователь получает право самостоятельно в личных некоммерческих целях создавать, использовать и определять содержание собственной персональной страницы и условия доступа других Пользователей к ее содержанию, а также получает возможности доступа и размещения информации на персональных страницах других Пользователей (при условии получения соответствующих прав доступа от их обладателей).<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• 4.12. Пользователь как обладатель информации, размещенной на собственной персональной странице, осознает, что за исключением случаев, установленных настоящими Правилами и действующими нормами международного права, Администрация Сайта не принимает участие в формировании и использовании содержания и контроле доступа других пользователей к персональной странице Пользователя.<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• 4.13. Создание и использование Сообществ.<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• 4.13.1. Пользователь вправе создавать Сообщества для целей продвижения коммерческих, политических, благотворительных и иных некоммерческих организаций, брендов, товаров, работ и услуг, а также различных мероприятий (далее – Объекты продвижения). Объекты продвижения, методы и способы их продвижения должны соответствовать международным правовым актам, настоящим Правилам, а также признанным этическим нормам и принципам морали, в том числе относящимся к таковым по мнению Администрации Сайта.<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• 4.13.2. При создании и администрировании Сообщества, Пользователь подтверждает, что действует на законных основаниях (например, по доверенности), обладает всеми необходимыми правами и не нарушает своими действиями законные права и интересы третьих лиц и действующие нормы международного права, в том числе законодательство о конкуренции и правах на результаты интеллектуальной деятельности и средства индивидуализации.<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• 4.13.3. В Сообществе, в том числе в описании, на главной фотографии Сообщества, в альбомах, в новостях, обсуждениях, опросах, аудиозаписях, видеозаписях, на стене, не допускается размещение Контента (в значении, предусмотренном п. 6.1.1. настоящих Правил) целиком или по частям без предварительного разрешения правообладателя, а также информации, предусмотренной п. 5.3.4. настоящих Правил. Пользователь, администрирующий Сообщество, обязан самостоятельно следить и пресекать не соответствующее Правилам размещение информации в Сообществе, и при необходимости блокировать пользователям, нарушающим настоящие Правила, доступ к Сообществу, используя функциональные возможности Сайта.<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• 4.13.4. В Сообществе, в том числе в описании, на главной фотографии Сообщества, в альбомах, в материалах, обсуждениях, опросах, закрепленных записях на стене и т.д., не допускается размещение сторонней коммерческой и политической рекламы. На стене Сообщества (за исключением закрепленных записей, в которых реклама не допускается) может быть размещено не более 3 (трёх) сторонних рекламных объявлений в сутки. На стене Сообщества, входящего в список популярных, может быть размещено не более 3 (трёх) сторонних рекламных объявлений в неделю. Сторонней рекламой признается любая информация, не имеющая прямого отношения к Сообществу и Объекту продвижения, распространяемая в любой форме как от лица Сообщества, так и от лица других сообществ и пользователей, и направленная на привлечение внимания пользователей к объекту рекламирования, формирование или поддержание интереса к нему. Пользователю, администрирующему Сообщество, необходимо самостоятельно следить и пресекать не соответствующее Правилам размещение сторонней рекламы в Сообществе.<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• 4.13.5. Все сторонние рекламные объявления должны соответствовать пп. 1 и 3 правил размещения рекламы Студентоси.<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• 4.13.6. Администрация Сайта вправе самостоятельно по своему усмотрению формировать и размещать список рекомендуемых Сообществ, исходя из их информационной ценности для пользователей и иных критериев. Для Сообществ, находящихся в списке рекомендуемых, действуют дополнительные ограничения – не более 3 (трёх) сторонних рекламных объявлений в неделю. В случае несоблюдения этого ограничения, Администрация Сайта вправе исключить Сообщество из списка рекомендуемых.<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• 4.13.7. Пользователь несет полную ответственность за свои действия, связанные с созданием и администрированием Сообществ, в соответствии с действующими международными правовыми актами и настоящими Правилами.<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• 4.13.8. В случае обнаружения факта нарушения в Сообществе законных прав и интересов третьих лиц, действующих норм международного права, а также положений настоящих Правил Администрация Сайта вправе, по своему выбору, принимать следующие меры: а) удалять Контент и иную информацию со страницы Сообщества и/или блокировать доступ к ним; б) блокировать доступ конкретных пользователей к странице Сообщества; в) блокировать доступ Пользователя, осуществляющего администрирование Сообщества, к Сообществу; г) передать права администрирования Сообщества, а также право использования зарегистрированного поддоменного имени, законному правообладателю, в установленном порядке подтвердившему свои права на Контент Сообщества, в том числе право на объекты авторского права, смежных прав, а также право на средство индивидуализации, сходное до степени смешения с используемым в Сообществе поддоменным именем; д) исключить Сообщество из системы поиска и/или заблокировать Сообщество; е) временно запретить публикацию любых ссылок в Сообществе.<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• 4.13.9. В случае нарушения Сообществом порядка размещения сторонней рекламы (предусмотренного в п. 4.13.4 настоящих Правил), Администрация Сайта вправе ограничить рекламную деятельность Сообщества. В случае попыток обойти техническое ограничение на публикацию ссылок (вставка дополнительных символов, публикация изображений со ссылками и т.д.) в период действия запрета, Администрация вправе заблокировать Сообщество без возможности восстановления.<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• 4.14. В отношении информации о себе Пользователь имеет право: (а) самостоятельного удалять ранее размещенную Пользователем информацию на Сайте; (б) самостоятельно удалять персональную страницу Пользователя с использованием функциональной возможности «удалить свою страницу», доступной Пользователю в разделе «Настройки».<br><br>
</div>
<div class="clear mgclr margin_top_10"></div>
<div class="sett_bar_title" style="    height: 14px;
    line-height: 14px;
    ...
    background: #fff;
    padding: 14px;
    box-shadow: 0 1px 0 0 #d7d8db, 0 0 0 1px #e3e4e8;">5. Обязанности Пользователя Студентоси</div>
<div class="clear mgclr margin_top_10" style="    margin-top: 0px;"></div>
<div style="    line-height: 160%;
    float: left;
    font-weight: normal;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- соблюдать положения действующих норм международного права, настоящих Правил и иных специальных документов Администрации Сайта;<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- не предоставлять доступ другим Пользователям к собственной персональной странице или к отдельной содержащейся на ней информации в случае, если это может привести к нарушению норм международного права и/или настоящих Правил, специальных документов Администрации cайта;<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- а также нарушает иные права и интересы граждан и юридических лиц или требования норм международного права.<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• 5.3.14. размещать коммерческую и политическую рекламу вне специальных разделов Сайта, установленных Администрацией Сайта.<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• 5.5. В случае несогласия Пользователя с настоящими Правилами или их обновлениями, Пользователь обязан отказаться от его использования, проинформировав об этом Администрацию Сайта в установленном порядке.<br><br>
</div>
<div class="clear mgclr margin_top_10"></div>
<div class="sett_bar_title" style="    height: 14px;
    line-height: 14px;
    ...
    background: #fff;
    padding: 14px;
    box-shadow: 0 1px 0 0 #d7d8db, 0 0 0 1px #e3e4e8;">6. Условия об интеллектуальных правах</div>
<div class="clear mgclr margin_top_10" style="    margin-top: 0px;"></div>
<div style="    line-height: 160%;
    float: left;
    font-weight: normal;
...
<div class="sett_bar_title" style="height: 14px;
    ...
    background: #fff;
    padding: 14px;
    box-shadow: 0 1px 0 0 #d7d8db, 0 0 0 1px #e3e4e8;">7. Функционирование Студентоси и ответственность при его использовании</div>
<div class="clear mgclr margin_top_10" style="    margin-top: 0px;"></div>
<div style="    line-height: 160%;
    float: left;
    font-weight: normal;
    ...
    padding: 14px;
    box-shadow: 0 1px 0 0 #d7d8db, 0 0 0 1px #e3e4e8;">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• 7.1. Пользователи несут ответственность за собственные действия в связи с созданием и размещением информации на собственной персональной странице на Сайте, а также в связи с размещением информации на персональных страницах других Пользователей и в иных разделах Сайта в соответствии с действующими нормами международного права. Нарушение настоящих Правил и действующих норм международного права влечет за собой гражданско-правовую, административную и уголовную ответственность.<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• 7.5. Администрация Сайта не занимается предварительной модерацией или цензурой информации Пользователей и предпринимает действия по защите прав и интересов лиц только после обращения заинтересованного лица к Администрации Сайта в установленном порядке.<br>
