<div class="friends_onefriend width_100">
 ...
 <div class="fl_l" style="width:500px">
  <a href="/{adres}" onClick="Page.Go(this.href); return false">{name} </a> <a onClick="trsn.box()" onMouseover="pageVerifiedTip(this, {text: '', shift: [5,5,0]});"> {verification} </a> <div class="friends_clr"></div>
