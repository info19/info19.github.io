...
<div style="width: 769px;
    ...
    padding: 14px;
    box-shadow: 0 1px 0 0 #d7d8db, 0 0 0 1px #e3e4e8;">
<div style="color: #567CA4;font-weight: 500;margin: 0 0 15px 19px;">Изменить пароль</div>
...
<div style="color: #567CA4;font-weight: 500;margin: 0 0 15px 19px;">Изменить имя</div>
...
<div style="width: 769px;
    ...
    background: #fff;
    padding: 14px;
    box-shadow: 0 1px 0 0 #d7d8db, 0 0 0 1px #e3e4e8;    height: 127px;">
<div style="color: #567CA4;font-weight: 500;margin: 0 0 15px 19px;">Адрес персональной страницы</div>
...
<div style=" width: 769px;
    ...
    background: #fff;
    padding: 14px;
    box-shadow: 0 1px 0 0 #d7d8db, 0 0 0 1px #e3e4e8;height: 177px;">
<div style="color: #567CA4;font-weight: 500;margin: 0 0 15px 19px;">Адрес Вашей электронной почты</div>
...
<div class="texta">Новый адрес:</div><input type="text" id="email" onfocus="$('#jp_check').fadeIn('normal');info.show(this.id, 'На указанный адрес будет отправлено письмо со ссылкой для потверждения.')" onblur="$('#jp_check').fadeOut('normal');info.hide(this.id);" placeholder="Введите новый e-mail" class="inpst" maxlength="100" style="width:242px;" /><span id="validName"/></span><div class="mgclr"><div class="texta">&nbsp;</div><div class="button_div fl_l" style="    margin-left: 160px;    margin-top: -20px;"><button onClick="settings.savenewmail(); return false" id="saveNewEmail" style="    float: left;
    margin-left: -161px;
    margin-top: 25px;">Сохранить адрес</button> <div class="stariidiz" style="padding: 10px;margin-bottom: 10px;line-height: 160%;text-align: center;font-weight:normal;margin-top: 66px;color: #65686c;margin-left: -185px;border: 1px solid #e7eaf0 !important;width: 480px;border-radius: 6px;border: none;background: #f2f4f7;">Вы можете вернуться на старый дизайн: <a href="/?act=change_skin" style="text-decoration: underline;">Активировать старый дизайн</a></div> </div><div class="clear"></div></div></div></div>