[record]<div class="wallrecord wall_upage2" id="wall_record_{rec-id}" style="padding-bottom:4px;margin-top:5px">
 ...
 <div class="wallauthor fl_l"><a class="colorauthor" href="/u{user-id}" onClick="Page.Go(this.href); return false">{name}</a> <span class="color777">{type}</span></div>
 ...
 <div class="infowalltext_f clear">
  ...
  <div class="public_likes_user_block no_display" id="public_likes_user_block{rec-id}" onMouseOver="groups.wall_like_users_five('{rec-id}')" onMouseOut="groups.wall_like_users_five_hide('{rec-id}')" style="margin-left:634px">
   ...
   <div class="public_wall_likes_hidden">
    <div class="public_wall_likes_hidden2">
     <a href="/i{viewer-id}" id="like_user{viewer-id}_{rec-id}" class="no_display" onClick="Page.Go(this.href); return false"><img src="{viewer-ava}" width="32" /></a>
 ...
 [privacy-comment][comments-link]<div class="wall_fast_form no_display" id="fast_form_{rec-id}" style="width: 700px;margin-left: -5px;">
   <div class="no_display wall_fast_texatrea" id="fast_textarea_{rec-id}">
	<textarea class="wall_inpst fast_form_width wall_fast_text" style="height:33px;color:#000;margin:0px;width:688px;    height: 19px;" id="fast_text_{rec-id}"
...
<div class="wall_fast_ava"><a href="/i{user-id}" onClick="Page.Go(this.href); return false"><img src="{ava}" alt="" /></a></div>
<div><a href="/i{user-id}" onClick="Page.Go(this.href); return false">{name}</a></div>
...
.public_wall_all_comm {
    ...
    width: 92%;
    margin-left: 59px;
    background: rgba(135, 163, 195, 0.15);
