...
<div style="float: left;width: 701px;margin-left: 0px;background: #fff;padding: 14px;box-shadow: 0 1px 0 0 #d7d8db, 0 0 0 1px #e3e4e8;">
...
[wall]<div class="public_likes_user_block no_display" id="public_likes_user_block{rec-id}" onMouseOver="groups.wall_like_users_five('{rec-id}'[wall-func], 'uPages'[/wall-func])" onMouseOut="groups.wall_like_users_five_hide('{rec-id}')" style="margin-left:632px">
  ...
  [wall]<div class="wall_tell_all cursor_pointer" onMouseOver="myhtml.title('{rec-id}', 'Отправить в сообщество или другу', 'wall_tell_all_')" onClick="Repost.Box('{rec-id}'[groups], 1[/groups]); return false "id="wall_tell_all_{rec-id}" style="margin-top: -5px;margin-right: 3px;"></div>[/wall]
...
[comment-form]<div class="wall_fast_opened_form" id="fast_form">
 <input type="text" class="wall_inpst fast_form_width wall_fast_input" value="Комментировать..." id="fast_inpt_{rec-id}" onMouseDown="wall.fast_open_textarea('{rec-id}', 2); return false" style="height:19px;margin:0px;width:688px" />
 <div class="no_display wall_fast_texatrea" id="fast_textarea_{rec-id}">
