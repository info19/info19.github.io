<div class="info_page"><a href="/{adres}"><img src="{photo}" align="left" width="100" height="100" style="margin-right:10px" />
<b>{title}</b></a><br />
...
<div style="margin-bottom:10px">Дата создания: <span style="color:#000">{date}</span>
</div></div>
