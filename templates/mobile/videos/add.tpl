...
<div class="videos_pad">
 <div class="allbar_title">Ссылка на видеоролик c YouTube.com</div>
 <input type="text" class="videos_input" id="video_lnk" onKeyUp="videos.load()" style="margin-bottom:5px" value="http://" />
 <span id="vi_info">
