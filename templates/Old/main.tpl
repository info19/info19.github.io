...
<link media="screen" href="/css/al/commonold.css" type="text/css" rel="stylesheet" />  
...
[logged]
<div class="fl_l site_nav" style="    height: 124124px;    width: 10230%;">

            <div class="site_nav_menu fl_r">
                <a href="{my-page-link}" onclick="Page.Go(this.href); return false;">
                    <div class="icon fl_l profile"></div>
                    <div class="str">{translate=mypagelinkd}</div>
                    <div class="clear"></div>
                </a>
                <a href="/friends{requests-link}" onclick="Page.Go(this.href); return false;" id="requests_link">
                    <div class="icon fl_l friends"></div>
                    <div class="str"><div id="new_requests" class="new fl_r">{demands}</div><span>{translate=friends}</span><div class="clear"></div></div>
                    <div class="clear"></div>
                </a>
                <a href="/messages" onclick="Page.Go(this.href); return false;">
                    <div class="icon fl_l im"></div>
                    <div class="str"><div id="new_msg" class="new fl_r">{msg}</div><span>{translate=lang_762}</span><div class="clear"></div></div>
                    <div class="clear"></div>
                </a>
               <a href="/audio" onclick="Page.Go(this.href); return false;">
                    <div class="icon fl_l music"></div>
                    <div class="str">{translate=lang_769}</div>
                    <div class="clear"></div>
                </a>
                <a href="/videos" onclick="Page.Go(this.href); return false;">
                    <div class="icon fl_l video"></div>
                    <div class="str">{translate=lang_768}</div>
                    <div class="clear"></div>
                </a>
                <a href="/albums/{my-id}" onclick="Page.Go(this.href); return false;" id="requests_link_new_photos">
                    <div class="icon fl_l photos"></div>
                    <div class="str"><div id="new_photos" class="new fl_r">{new_photos}</div><span>{translate=lang_764}</span><div class="clear"></div></div>
                    <div class="clear"></div>
                </a>
                <a href="{groups-link}" onclick="Page.Go(this.href); return false;">
                    <div class="icon fl_l groups"></div>
                    <div class="str"><div id="new_groups" class="new fl_r">{new_groups}</div><span>{translate=lang_770}</div>
                    <div class="clear"></div>
                </a>
                <a href="/fave" onclick="Page.Go(this.href); return false;">
                    <div class="icon fl_l fave"></div>
                    <div class="str">{translate=lang_766}</div>
                    <div class="clear"></div>
                </a>
                <a href="/notes" onclick="Page.Go(this.href); return false;">
                    <div class="icon fl_l notes"></div>
                    <div class="str">{translate=lang_772}</div>
                    <div class="clear"></div>
                </a>
                <a href="/news" onclick="Page.Go(this.href); return false;" id="news_link">
                    <div class="icon fl_l news"></div>
                    <div class="str"><div id="new_news" class="new fl_r">{new-news}</div><span>{translate=lang_771}</span><div class="clear"></div></div>
                    <div class="clear"></div>
                </a>
            </div>
        </div>
...
<div class="autowr">
 <div class="content" [logged]style="width:800px;margin-left:108px;"[/logged]>
...
<a href="/?go=search&type=1" onClick="Page.Go(this.href); return false">{translate=lang_footerp}</a>
  ...
  <a href="/blog" onClick="Page.Go(this.href); return false">{translate=blog_title}</a>
   <div class="copyright">
   Studentosi.Ru &copy; 2016<a class="cursor_pointer" onClick="trsn.box()" onmouseover="showTooltip(this, {text: '{translate=lang_790}', shift: [5,5,0]});">{translate=fotlang}</a><br>
