<script type="text/javascript" src="/js/al/swfupload.js"></script>
...
<div class="menuNews">
 <li onClick="Page.Go('/albums/{user-id}')">Все альбомы</li>
<li onClick="Page.Go('/albums/view/{aid}')">{album-name}</li>
<li onClick="Page.Go('/albums/add/{aid}')" class="activClass">Добавление фотографий</li>
</div>
