<script type="text/javascript" src="/js/al/jquery.1.7.2.js"></script>
<script type="text/javascript" src="/js/al/jquery.graph.js"></script>
...
<div class="search_form_tab" style="margin-top:-9px">
 <div class="buttonsprofile albumsbuttonsprofile buttonsprofileSecond" style="height:22px">
  ...
  <div class="fl_r">
   ...
   <div class="button_blue fl_l"><button onClick="location.href = '/stats?gid={gid}&m='+$('#month').val()+'&y='+$('#year').val()">Просмотреть</button></div>
  </div>
 </div>
</div>
<div class="clear"></div>
