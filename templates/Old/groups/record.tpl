...
<div class="size10 infowalltext_f clear">
  ...
  <div class="fl_r public_wall_like cursor_pointer" onClick="{like-js-function}" onMouseOver="groups.wall_like_users_five('{rec-id}')" onMouseOut="groups.wall_like_users_five_hide('{rec-id}')" id="wall_like_link{rec-id}">
   ...
   <div class="wall_tell_all cursor_pointer" onMouseOver="myhtml.title('{rec-id}', 'Отправить в сообщество или другу', 'wall_tell_all_')" onClick="Repost.Box('{rec-id}', 1); return false "id="wall_tell_all_{rec-id}" style="margin-top:-6px;margin-right:6px;[owner]margin-top:-6px;margin-right:6px[/owner]"></div>
