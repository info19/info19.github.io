...
<script type="text/javascript" src="/js/al/profile_edit.js"></script>
[general]
<br>
<div class="menuNews">
    <li onClick="Page.Go('/editmypage')"class="activClass">Основное</li>
    <li onClick="Page.Go('/editmypage/contact')">Контакты</li>
    <li onClick="Page.Go('/editmypage/interests')">Интересы</li>
    <div class="clear"></div>
</div>
...
<div class="clear"></div>
<br>
<div class="err_yellow" id="info_save" style="display:none;font-weight: normal;width: 620px;margin-left: 30px;margin-top: -30px;"></div>
<div class="clear"></div>

<div style="width:600px;margin: 0px auto 0px;">
...
<div class="texta">&nbsp;</div><div class="button_div fl_l"><button id="saveform">Сохранить</button></div><div class="mgclr"></div></div></div>
[/general]
[contact]
<br>
<div class="menuNews">
    <li onClick="Page.Go('/editmypage')">Основное</li>
    <li onClick="Page.Go('/editmypage/contact')"class="activClass">Контакты</li>
    <li onClick="Page.Go('/editmypage/interests')">Интересы</li>
    <div class="clear"></div>
</div>
<div class="edit_general_wrap"> 
<div class="err_yellow" id="info_save" style="display:none;font-weight: normal;width: 620px;margin-left: 30px;margin-top: -10px;"></div>
<div class="clear"></div>
<br>
<div style="width:600px;margin:0px auto 0px;">
...
<div class="texta">ВКонтакте:</div><input type="text" id="vk" class="inpst" maxlength="100" value="{vk}" style="width:200px;" /><span id="validVk"></span><div class="mgclr"></div>
...
<div class="texta">ICQ:</div><input type="text" id="icq" class="inpst" maxlength="30" value="{icq}" style="width:200px;" /><span id="validIcq"></span><div class="mgclr"></div>
...
<div class="texta">&nbsp;</div><div class="button_div fl_l"><button name="save" id="saveform_contact">Сохранить</button></div><div class="mgclr"></div></div></div>
[/contact]
[interests]
<br>
<div class="menuNews">
    <li onClick="Page.Go('/editmypage')">Основное</li>
    <li onClick="Page.Go('/editmypage/contact')">Контакты</li>
    <li onClick="Page.Go('/editmypage/interests')"class="activClass">Интересы</li>
    <div class="clear"></div>
</div>
<div class="edit_general_wrap"> 
<div class="err_yellow" id="info_save" style="display:none;font-weight: normal;width: 620px;margin-left: 30px;margin-top: -10px;"></div>
