	...
	$(window).scroll(function(){
		if($('#type_page').val() == 'profile'){
			...
			if($(window).scrollTop() > $('#fortoAutoSizeStyleProfile').offset().top && !startResizeCss){
				startResizeCss = true;
				$('body').append('<div id="addStyleClass"><style type="text/css" media="all">.wallrecord{width:777px;margin-left:-210px}.infowalltext_f{font-size:11px}.wall_inpst{width:688px}.public_likes_user_block{margin-left:607px}.wall_fast_opened_form{width:698px;margin-left:-150px}.wall_fast_block{width:710px;margin-top:2px;margin-left:-150px}.public_wall_all_comm{width:692px;margin-top:2px;margin-bottom:-2px}.player_mini_mbar_wall{width:710px;margin-bottom:0px}#audioForSize{min-width:700px}.wall_rec_autoresize{width:700px}.wall_fast_ava img{width:50px}.wall_fast_ava{width:60px}.wall_fast_comment_text{margin-left:57px}.wall_fast_date{margin-left:57px;font-size:11px}.public_wall_all_comm{margin-left:-150px}.size10{font-size:11px}</style></div>');
			}
		}
	});
	music.jPlayerInc();
...
[owner]
<a href="/docs" onClick="Page.Go(this.href); return false;"><img class="icon doc_ic" src="{theme}/images/spacer.gif" alt="" /><div>{translate=lang_835}</div></a>
<a href="/editmypage" onClick="Page.Go(this.href); return false;"><img class="icon edit_ic" src="{theme}/images/spacer.gif" alt="" /><div>{translate=strred}</div></a>
<a href="/" onClick="Profile.LoadPhoto(); return false;"><img class="icon editphoto_ic" src="{theme}/images/spacer.gif" alt="" /><div>{translate=lang_837}</div></a>
<a href="/" onClick="Profile.DelPhoto(); return false;" id="del_pho_but" {display-ava}><img class="icon del_photo_ic" src="{theme}/images/spacer.gif" alt="" /><div>{translate=lang_839}</div></a>[/owner]
[not-owner][blacklist][privacy-msg]<a href="/" onClick="messages.new_({user-id}); return false"><img class="icon mail_ic" src="{theme}/images/spacer.gif" alt="" /><div>{translate=lang_840}</div></a>[/privacy-msg][/blacklist]
[no-friends][blacklist]<a href="/" onClick="friends.add({user-id}); return false"><img class="icon addfr_ic" src="{theme}/images/spacer.gif" alt="" /><div>{translate=lang_841}</div></a>[/blacklist][/no-friends]
[yes-friends]<a href="/" onClick="friends.delet({user-id}, 1); return false"><img class="icon del_friends" src="{theme}/images/spacer.gif" alt="" /><div>{translate=lang_842}</div></a>[/yes-friends]
[blacklist][no-subscription]<a href="/" onClick="subscriptions.add({user-id}); return false" id="lnk_unsubscription"><img class="icon subs_ic" src="{theme}/images/spacer.gif" alt="" /><div><span id="text_add_subscription">{translate=lang_843}</span> <img src="/templates/Default/images/loading_mini.gif" alt="" id="addsubscription_load" class="no_display" style="margin-right:-13px" /></div></a>[/no-subscription][/blacklist]
[yes-subscription]<a href="/" onClick="subscriptions.del({user-id}); return false" id="lnk_unsubscription"><img class="icon subs_ic" src="{theme}/images/spacer.gif" alt="" /><div><span id="text_add_subscription">{translate=lang_844}</span> <img src="/templates/Default/images/loading_mini.gif" alt="" id="addsubscription_load" class="no_display" style="margin-right:-13px" /></div></a>[/yes-subscription]
<a href="/" onClick="gifts.box('{user-id}'); return false"><img class="icon new_gift" src="{theme}/images/spacer.gif" alt="" /><div>{translate=lang_845}</div></a>
[no-fave]<a href="/" onClick="fave.add({user-id}); return false" id="addfave_but"><img class="icon fav_ic" src="{theme}/images/spacer.gif" alt="" /><div><span id="text_add_fave">{translate=lang_846}</span> <img src="/templates/Default/images/loading_mini.gif" alt="" id="addfave_load" class="no_display" /></div></a>[/no-fave]
[yes-fave]<a href="/" onClick="fave.delet({user-id}); return false" id="addfave_but"><img class="icon fav_ic" src="{theme}/images/spacer.gif" alt="" /><div><span id="text_add_fave">{translate=lang_847}</span> <img src="/templates/Default/images/loading_mini.gif" alt="" id="addfave_load" class="no_display" /></div></a>[/yes-fave]
[no-blacklist]<a href="/" onClick="settings.addblacklist({user-id}); return false" id="addblacklist_but"><img class="icon compla_ic" src="{theme}/images/spacer.gif" alt="" /><div><span id="text_add_blacklist">{translate=lang_848}</span> <img src="/templates/Default/images/loading_mini.gif" alt="" id="addblacklist_load" class="no_display" /></div></a>[/no-blacklist]
[yes-blacklist]<a href="/" onClick="settings.delblacklist({user-id}, 1); return false" id="addblacklist_but"><img class="icon compla_ic" src="{theme}/images/spacer.gif" alt="" /><div><span id="text_add_blacklist">{translate=lang_849}</span> <img src="/templates/Default/images/loading_mini.gif" alt="" id="addblacklist_load" class="no_display" /></div></a>[/yes-blacklist]
[/not-owner]
</div>
...
[blacklist]<div class="leftcbor">
 [owner][happy-friends]<div id="happyBLockSess"><div class="albtitle">{translate=lang_850} <span>{happy-friends-num}</span><div class="profile_happy_hide"><img src="{theme}/images/hide_lef.gif" onMouseOver="myhtml.title('1', 'Скрыть', 'happy_block_')" id="happy_block_1" onClick="HappyFr.HideSess(); return false" /></div></div>
...
[friends_pod]
<a href="/?go=search&query=&type=1" onClick="Page.Go(this.href); return false" style="text-decoration:none"><div class="albtitle">{translate=lang_854} </div></a> 
<br>	
...
[/owner]
 ...
 [subscriptions]<a href="/" onClick="subscriptions.all({user-id}, '', {subscriptions-num}); return false" style="text-decoration:none"><div class="albtitle">{translate=lang_846interes} <span>{subscriptions-num}</span></div></a>
 <div class="newmesnobg" style="padding-right:0px;padding-bottom:0px;">{subscriptions}<div class="clear"></div>
 </div>[/subscriptions]

 [groups]<div class="albtitle cursor_pointer" onClick="groups.all_groups_user('{user-id}')">{translate=lang_857} <span id="groups_num">{groups-num}</span></div>
 <div class="newmesnobg" style="padding-right:0px;padding-bottom:0px;">{groups}<div class="clear"></div>
 </div>[/groups]

[owner][public_pod]
<a href="/?go=search&type=4&query=" onClick="Page.Go(this.href); return false" style="text-decoration:none"><div class="albtitle" style="margin-top:5px">{translate=lang_857} <div></div></div></a>
<br>
...
[/public_pod][/owner]
 ...
 [albums]<br><a href="/albums/{user-id}" onClick="Page.Go(this.href); return false" style="text-decoration:none"><div class="albtitle" style="margin-top:5px">{translate=lang_890} <span>{albums-num}</span><div></div></div>{albums}</a><div class="clear"></div><br>[/albums]

 [videos]<a href="/videos/{user-id}" onClick="Page.Go(this.href); return false" style="text-decoration:none"><div class="albtitle">{translate=lang_858} <span>{videos-num}</span></div></a>
 <div class="newmesnobg" style="padding-right:0px;padding-bottom:0px;">{videos}<div class="clear"></div>
 </div>[/videos]


[owner][videos_pod]	
<a href="/videos/{user-id}" onClick="Page.Go(this.href); return false" style="text-decoration:none"><div class="albtitle" style="margin-top: 8px;">{translate=lang_858} </div></a> 
<br>	
...
<div class="profiewr">
 [owner]<div class="set_status_bg no_display" id="set_status_bg">
  <input type="text" id="status_text" class="status_inp" value="{status-text}" style="width:555px;    height: 17px;" maxlength="255" onKeyPress="if(event.keyCode == 13)gStatus.set()" />
...
<div class="titleu" style="    font-size: 13px;
    font-weight: bold;
    color: #567ca4;"> {name} {lastname}<div class="online_time" style="    margin-top: -46px;    margin-right: -3px;">{online}</div></div>
 <div class="status">
...
[privacy-info]<div class="cursor_pointer" onClick="Profile.MoreInfo(); return false" id="moreInfoLnk"><div class="public_wall_all_comm profile_hide_opne" id="moreInfoText">{translate=lang_872}</div></div>[/privacy-info]
 ...
 [privacy-info][not-block-contact] <br><div class="profile_inf_title"><div class="w2_a" [owner]style="width:230px;"[/owner]>{translate=lang_873} [owner]<span><a href="/editmypage/contact" onClick="Page.Go(this.href); return false;"><div class="icon-pencil-6"></div></a></span>[/owner]</div></div>
...
[not-contact-icq]<div class="flpodtext"> icq:</div> <div class="flpodinfo"><a href="/?go=search&mesto=1" onClick="Page.Go(this.href); return false">{icq}</a></div>[/not-contact-icq]
 ...
 <br><div class="profile_inf_title"><div class="w2_" [owner]style="width:200px;"[/owner]>{translate=lang_880} [owner]<span><a href="/editmypage/interests" onClick="Page.Go(this.href); return false;"><div class="icon-pencil-6"></div></a></span>[/owner]</div></div>{not-block-info}
...
<br>
 [gifts]<a href="/gifts{user-id}" onClick="gifts.browse({user-id}); return false" style="text-decoration:none"><div class="albtitle" style="margin-top:5px;font-size: 14px;      color: #525559;"><i class="icon-gift profileicon"></i>&nbsp; {gifts-text}<div></div></div><center>{gifts}</center><div class="clear"></div></a>[/gifts]
 ...
 <a href="/wall{user-id}" onClick="Page.Go(this.href); return false" style="text-decoration:none"><div class="albtitle" style="border-bottom:0px;font-size: 14px;      color: #525559;"><i class="icon-feather profileicon"></i>&nbsp; {translate=lang_892} <span id="wall_rec_num">{wall-rec-num}</span></div></a>
 [privacy-wall]<div class="newmes" id="wall_tab" style="border-bottom:0px;margin-bottom:-5px">
  ...
  <input type="text" class="wall_inpst" value="[owner]{translate=lang_893}[/owner][not-owner]{translate=lang_894}[/not-owner]" onMouseDown="wall.form_open(); return false" id="wall_input" style="    width: 528px;margin:0px" />
