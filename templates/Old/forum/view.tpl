...
<div class="forum_text">
 ...
 <div class="no_display" id="editTextTab">
  <textarea class="inpst" style="width:580px;height:120px" id="editText">{edit-text}</textarea>
...
<textarea 
	...
	id="fast_text_1" 
	style="width:602px;height:37px;color:#c1cad0;margin-left:3px;color:#000"
